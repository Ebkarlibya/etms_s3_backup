// Copyright (c) 2023, yosef@ebkar.ly and contributors
// For license information, please see license.txt

frappe.ui.form.on('ETMS S3 Backup', {
		...
		take_backup: function (frm) {
			if (frm.doc.access_key_id && frm.doc.secret_access_key) {
				frm.add_custom_button(__("Take Backup Now"), function () {
					...
					frappe.call({
						method: "etms_s3_backup.etms_s3_backup.doctype.etms_s3_backup.etms_s3_backup.take_backups_s3",
						callback: function (r) {
							if (!r.exc) {
